...
import { ArrowLeft, ArrowRight, Mouse } from "iconsax-react";
  ...
  return (
    <div
      ...
      className={cn(
        "absolute",
        vertical
          ? "right-64 top-1/2 flex -translate-y-1/2 flex-col"
          : "bottom-4 left-1/2 flex -translate-x-1/2 flex-row",
        className,
      )}
      {...props}
    >
...
const CustomCarouselScrollDown = React.forwardRef<
  HTMLButtonElement,
  React.ButtonHTMLAttributes<HTMLButtonElement>
>(({ className, ...props }, ref) => {
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center">
        <Mouse size={32} variant="Broken" className="text-backgroundmerino" />
        <p className="text-backgroundmerino font-['SVN-Gotham'] text-[18px] font-normal leading-[150%]">
          Scroll Down
        </p>
      </div>
    </button>
...
CustomCarouselScrollDown.displayName = "CustomCarouselScrollDown";
